...
RUN case ${TARGETPLATFORM} in \
        "linux/amd64") wget -O /tmp/ost-devel.sh https://gitlab.ost.ch/tech/inf/public/yocto/meta-mse-tsm-autmobros/-/package_files/6019/download ;; \
        "linux/arm64") wget -O /tmp/ost-devel.sh https://gitlab.ost.ch/tech/inf/public/yocto/meta-mse-tsm-autmobros/-/package_files/6018/download ;; \
    esac \
