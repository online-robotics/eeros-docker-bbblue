...
RUN apt-get update && apt-get install -y git python cmake iputils-ping

ADD https://gitlab.ost.ch/tech/inf/public/yocto/meta-mse-tsm-autmobros/-/package_files/5925/download /tmp/ost-devel-glibc-x86_64-autmobros-image-dunfell-dev-cortexa8hf-neon-bblue-toolchain-1.0.sh
